...
const mealDetails = document.querySelector(".first-meal-detail");
const mealCloseBtn = document.getElementById("recipe-close-btn");

function get1stRecipeDetails(){
  document.querySelector(".first-meal-detail").style.display ="block"
}
...
function closeBtn(){
  document.querySelector(".first-meal-detail").style.display = "none"
